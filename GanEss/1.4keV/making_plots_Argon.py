...
use_charge = [Q_init_cum, Q_cum, Q_cum[m2], Q_cum[m3], Q_cum[m4]] # choose here what you want to plot
...
# ============================================================
# FIT 2 : centered Gaussian at 2.9 keV
# ============================================================
...
#  Here we just check waveform distributions
...
if wfplot==True:
    ...
    c3 = m4 & mask_ene # Waveform in a defined energy range and after all cuts
    #c3 = mask_ene
    wfplot3 = wf[c3][:50000]
