...
#loading of data
charge = np.loadtxt("/Users/ldonneger/Desktop/PhD_Thesis2/GanEss/1.4keV/Argon/Q_Ar_"+str(run_nb)+"_evts_["+str(event_min)+"-"+str(event_max)+"]_"+wd_func+".npy")
...
t03 = np.loadtxt("/Users/ldonneger/Desktop/PhD_Thesis2/GanEss/1.4keV/Argon/t03_Ar_"+str(run_nb)+"_evts_["+str(event_min)+"-"+str(event_max)+"]_"+wd_func+".npy")
t07 = np.loadtxt("/Users/ldonneger/Desktop/PhD_Thesis2/GanEss/1.4keV/Argon/t07_Ar_"+str(run_nb)+"_evts_["+str(event_min)+"-"+str(event_max)+"]_"+wd_func+".npy")
fluct = np.loadtxt("/Users/ldonneger/Desktop/PhD_Thesis2/GanEss/1.4keV/Argon/fluct_Ar_"+str(run_nb)+"_evts_["+str(event_min)+"-"+str(event_max)+"]_"+wd_func+".npy")

#Definition of binnings for histo
fluctbins = np.linspace(8e-8, 1e-6, 200)
enebinskev = np.linspace(0, 6, 60)
timebins = np.linspace(0, 4, 50)

#Rising time
diff = (t07-t03) * 40/5000

#Find the 5.9 keV peak and do the conversion from ADC counts to keV
mask_to_kev = (charge>=4000)
to_kev = np.max(charge[mask_to_kev])
...
np.savetxt("/Users/ldonneger/Desktop/PhD_Thesis2/GanEss/1.4keV/Argon/diff1D_histo_Ar_"+str(run_nb)+"_evts_["+str(event_min)+"-"+str(event_max)+"]_"+wd_func+".npy", histo1)
...
x = (bins[:-1] + bins[1:]) / 2
xmin = 1 #Min value of the window for the gaussian fitting
...
np.savetxt("/Users/ldonneger/Desktop/PhD_Thesis2/GanEss/1.4keV/Argon/fluct1D_histo_Ar_"+str(run_nb)+"_evts_["+str(event_min)+"-"+str(event_max)+"]_"+wd_func+".npy", histo2)
...
x = (bins[:-1] + bins[1:]) / 2
xmin = 0.25e-6 #Min value of the window for the gaussian fitting
