...
wd_func="coif" #wavelet function to use for the denoising
...
python denoised.py $run_nb $evt_start $wd_func $gas $f_numb $main_path
#python fluct_wf.py $run_nb $evt_start $wd_func $gas $f_numb $main_path

python fluct_study.py $run_nb $evt_start $wd_func $gas $f_numb $main_path
python time_generation.py $run_nb $evt_start $wd_func $gas $f_numb $main_path
