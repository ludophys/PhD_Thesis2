...
run_nb = ['3131']#, '3132', '3133', '3134']#, '3135', '3136', '3137', '3138']
#run_nb = ['3300', '3301', '3302', '3303'] #Argon
...
for i in range(len(run_nb)):
    for j in range(len(intervals)):
        try:
            ...
            Q_init_file = np.loadtxt("/Users/ldonneger/Desktop/PhD_Thesis2/GanEss/1.4keV/Argon/"+folder+"/Q_Ar_['"+run_nb[i]+"']_evts_["+intervals[j]+"]_"+wd_func+".npy")
            Q_init_cum.extend(Q_init_file)

            # Denoised charge after first selection
            Q_file = np.loadtxt("/Users/ldonneger/Desktop/PhD_Thesis2/GanEss/1.4keV/Argon/"+folder+"/Q_den_Ar_['"+run_nb[i]+"']_evts_["+intervals[j]+"]_"+wd_func+".npy")
            Q_cum.extend(Q_file)

            t03_file = np.loadtxt("/Users/ldonneger/Desktop/PhD_Thesis2/GanEss/1.4keV/Argon/"+folder+"/t03_Ar_['"+run_nb[i]+"']_evts_["+intervals[j]+"]_"+wd_func+".npy")
            t03.extend(t03_file)

            t07_file = np.loadtxt("/Users/ldonneger/Desktop/PhD_Thesis2/GanEss/1.4keV/Argon/"+folder+"/t07_Ar_['"+run_nb[i]+"']_evts_["+intervals[j]+"]_"+wd_func+".npy")
            t07.extend(t07_file)
            ...
            fluct_file = np.loadtxt("/Users/ldonneger/Desktop/PhD_Thesis2/GanEss/1.4keV/Argon/"+folder+"/fluct_Ar_['"+run_nb[i]+"']_evts_["+intervals[j]+"]_"+wd_func+".npy")
            fluct.extend(fluct_file)

            if wfplot==True:
                wf_file = np.loadtxt("/Users/ldonneger/Desktop/PhD_Thesis2/GanEss/1.4keV/Argon/"+folder+"/wf_Ar_['"+run_nb[i]+"']_evts_["+intervals[j]+"]_"+wd_func+".npy")
...
plt.tight_layout()
if save == True:
    plt.savefig("/Users/ldonneger/Desktop/PhD_Thesis2/GanEss/1.4keV/Argon/TOT_diff2D_"+wd_func+".pdf",
...
plt.tight_layout()
if save == True:
    plt.savefig("/Users/ldonneger/Desktop/PhD_Thesis2/GanEss/1.4keV/Argon/TOT_fluct2D_"+wd_func+".pdf",
                dpi=600, bbox_inches="tight")
